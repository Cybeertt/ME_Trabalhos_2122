...
A variável em estudo é a *Initial Spread Index* (temp) e é uma variável contínua.
...
# histograma
hist(hour$temp, main="Histograma temp", xlab="temp",  ylab="Indice", nclass=hour.temp.sturges.nclass)
```
