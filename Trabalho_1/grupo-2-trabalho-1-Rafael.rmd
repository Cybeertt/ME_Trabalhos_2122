...
# Classes is between 1 to 488
bikes.rentless <- subset(bikes, cnt<=488)

# Classes is between 488 to 977
bikes.rentmore <- subset(bikes, 488<cnt)
...
# histograma
hist(bikes$temp, main="Histograma FFMC", xlab="FFMC",  ylab="Indice", nclass=bikes.temp.sturges.nclass)
```
