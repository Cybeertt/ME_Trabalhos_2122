...
```{r, evail = T}
values <- c(nrow(bikes.day), nrow(bikes.night)) 
labels <- c("Rent Day", "Rent Night")

barpercent<- round(100*x/sum(x), 1)
...
x <- c(nrow(bikes.day), nrow(bikes.night))
labels <- c("Rent Day", "Rent Night")

piepercent<- round(100*x/sum(x), 1)

pie(x, labels = piepercent, main = "Rent bikes pie chart",col = rainbow(length(x)))
